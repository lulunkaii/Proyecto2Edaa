...
plt.savefig('grafico_construccion_final2.png')
print("Gráfico de Tiempos de Construcción guardado como 'grafico_construccion_final2.png'")
...
plt.grid(axis='y', linestyle='--')
plt.tight_layout()
plt.savefig('grafico_tiempo_consulta_final2.png')
print("Gráfico de Tiempos de Búsqueda guardado como 'grafico_tiempo_consulta_final2.png'")
...
plt.grid(axis='y', linestyle='--')
plt.tight_layout()
plt.savefig('grafico_tasa_localizacion_final2.png')
...
plt.grid(axis='y', linestyle='--')
plt.tight_layout()
plt.savefig('grafico_docs_encontrados_final2.png')
print("Gráfico de Documentos Encontrados guardado como 'grafico_docs_encontrados_final2.png'")
