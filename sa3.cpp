...
int main(int argc, char** argv) {
  ...
  std::ifstream pos_file("posiciones3.txt");
  if (!pos_file.is_open()) {
      cerr << "ERROR: No se pudo abrir posiciones3.txt. Asegúrese de que existe en este directorio." << endl;
      return 1;
  }
  ...
  if (temp_positions.empty()) {
      cerr << "ERROR: El archivo posiciones3.txt está vacío o mal formateado." << endl;
      return 1;
  }
